...
},{"./lib/helpers/array-diff":31,"./lib/helpers/ucfirst":36,"./lib/v-client-table":71,"./lib/v-server-table":72}],15:[function(require,module,exports){
...
},{"../helpers/is-valid-moment-object":34}],25:[function(require,module,exports){
...
},{"../helpers/is-valid-moment-object":34,"../helpers/object-filled-keys-count":35}],30:[function(require,module,exports){
module.exports = function(data) {
...
},{"../table-template.html":70}],33:[function(require,module,exports){
...
},{"merge":73}],42:[function(require,module,exports){
...
},{"merge":73}],45:[function(require,module,exports){
var merge = require('merge');
...
},{"merge":73}],46:[function(require,module,exports){
module.exports = function(column) {
...
},{"../computed/all-columns":15,"../computed/custom-columns":16,"../computed/list-columns-object":18,"../computed/templates-keys":20}],66:[function(require,module,exports){
...
},{"../helpers/is-empty":33}],67:[function(require,module,exports){
module.exports = {
  data: function() {
      return {
        id: makeId(),
...
},{"../filters/highlight-matches":25,"../filters/option-text":26,"../filters/render":28}],69:[function(require,module,exports){
module.exports =   {
  methods: {
...
},{"../methods/add-custom-columns":37,"../methods/compile-templates":38,"../methods/display":39,"../methods/filterable":40,"../methods/get-heading":42,"../methods/init-date-filters":44,"../methods/init-options":45,"../methods/init-order-by":46,"../methods/init-pagination":47,"../methods/init-query":48,"../methods/is-date-filter":50,"../methods/is-list-filter":51,"../methods/is-text-filter":52,"../methods/order-by-column":53,"../methods/search":57,"../methods/set-page":60,"../methods/sortable":63,"../methods/sortable-chevron-class":61,"../methods/sortable-class":62}],70:[function(require,module,exports){
...
},{"./computed/custom-q":17,"./computed/q":19,"./computed/total-pages":21,"./config/defaults":22,"./filters/custom-filters":23,"./filters/date":24,"./filters/page":27,"./filters/search":29,"./filters/set-count":30,"./helpers/generate-table-html":32,"./methods/init-client-filters":43,"./methods/register-client-filters":55,"./methods/set-client-watchers":58,"./methods/transform-date-strings-to-moment":64,"./mixins/computed":65,"./mixins/created":66,"./mixins/data":67,"./mixins/filters":68,"./mixins/methods":69,"v-pagination":74}],72:[function(require,module,exports){
var methods = require('./mixins/methods');
var filters = require('./mixins/filters');
var computed = require('./mixins/computed');
var data = require('./mixins/data');
...
},{"./computed/total-pages":21,"./config/defaults":22,"./helpers/generate-table-html":32,"./methods/get-data":41,"./methods/init-server-filters":49,"./methods/refresh":54,"./methods/register-server-filters":56,"./methods/set-data":59,"./mixins/computed":65,"./mixins/created":66,"./mixins/data":67,"./mixins/filters":68,"./mixins/methods":69,"v-pagination":74}],73:[function(require,module,exports){
/*!
...
},{"./src/template.html":75}],75:[function(require,module,exports){
...
exports.default = {
  ...
  methods: {
    validate_form: function validate_form() {
      ...
      this.column_object.map(function (input) {
        if (_this._.has(input, 'required') && input.required == true) {
          var required_id = _this._.findIndex(_this.column_object, function (i) {
            return i.label == input.label;
          });
          if (_this.form_data[input.label]) {
            _this.column_object[required_id].warning = false;
            _this.form_success = true;
          } else {
            _this.column_object[required_id].warning = true;
    ...
    submit_form: function submit_form(e) {
      ...
      if (this.form_success) {
        this.$http.post(this.endpoint, this.form_data).then(function (response) {
          $("#crud_insert_modal").modal('toggle');
          _this2.$dispatch('update_table');
  ...
  ready: function ready() {
    ...
    parsed_column.map(function (col) {
      col.warning = false;
    });
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-33c04bd0", module.exports)
  } else {
    hotAPI.update("_v-33c04bd0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":76,"vue-hot-reload-api":12}],78:[function(require,module,exports){
'use strict';
...
var _CrudInsert = require('./CrudInsert.vue');

var _CrudInsert2 = _interopRequireDefault(_CrudInsert);
...
exports.default = {
  ...
  components: {
    CrudInsert: _CrudInsert2.default
  },
  methods: {
    fetch_data: function fetch_data() {
      ...
      this.$http.get(this.endpoint).then(function (response) {
        ...
        (0, _sweetalert2.default)("Oops!", "failed to load data.", "error");
      });
    },
    fetch_edit: function fetch_edit(id) {
      var _this2 = this;

      this.$http.get(this.endpoint + "/" + id).then(function (response) {
        _this2.form_data = response.data;
      });
    },
    add_actions: function add_actions() {
      this.table_data.map(function (rowdata) {
        rowdata.action = "<div class=\"dropdown\">" + "<button class=\"btn btn-primary btn-sm dropdown-toggle\" type=\"button\" data-toggle=\"dropdown\">Action " + "<span class=\"caret\"></span></button>" + "<ul class=\"dropdown-menu\">" + "<li><a @click=\"this.$parent.edit_row(" + rowdata.id + ")\">Edit</a></li>" + "<li><a @click=\"this.$parent.delete_row(" + rowdata.id + ")\">Delete</a></li>" + "</ul>" + "</div>";
      });
    },
    edit_row: function edit_row(id) {
    ...
    delete_row: function delete_row(id) {
      ...
      (0, _sweetalert2.default)({
        ...
        vm.$http.delete(vm.endpoint + "/" + id).then(function (response) {
          if (response.status == 200) {
            (0, _sweetalert2.default)("Deleted!", "delete success.", "success");
            vm.fetch_data();
          } else {
            console.log(response);
            (0, _sweetalert2.default)("Oops!", "problem has occured", "error");
          }
        });
      });
    },
    edit_submit_form: function edit_submit_form(e) {
      var _this3 = this;
      ...
      this.validate_form();
      if (this.form_success) {
        this.$http.put(this.endpoint + "/" + this.edit_id, this.form_data).then(function (response) {
          if (response.status == 200) {
            $("#crud_edit_modal").modal('toggle');
            (0, _sweetalert2.default)("Updated!", "update success.", "success");
            _this3.fetch_data();
          }
        }, function (response) {
          $("#crud_edit_modal").modal('toggle');
          (0, _sweetalert2.default)("Oops!", "problem occured.", "error");
          _this3.fetch_data();
        });
      }
    },
    validate_form: function validate_form() {
      ...
      this.column_object.map(function (input) {
        if (vm.lodash.has(input, 'required') && input.required == true) {
          var required_id = vm.lodash.findIndex(vm.column_object, function (i) {
            return i.label == input.label;
          });
  ...
  ready: function ready() {
    ...
    parsed.map(function (col) {
      col.warning = false;
    });
    this.column_object = parsed;
    parsed.map(function (col) {
      _this5.column_header.push(col.label);
    });
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5d987544", module.exports)
  } else {
    hotAPI.update("_v-5d987544", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./CrudInsert.vue":77,"lodash":2,"sweetalert":11,"vue":76,"vue-hot-reload-api":12}],79:[function(require,module,exports){
'use strict';
...
var _vueTables = require('vue-tables');

var _vueTables2 = _interopRequireDefault(_vueTables);

var _CrudWrapper = require('./components/CrudWrapper.vue');

var _CrudWrapper2 = _interopRequireDefault(_CrudWrapper);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.config.devtools = true;
_vue2.default.use(_vueTables2.default.client, {
...
new _vue2.default({
  ...
  components: {
    CrudTable: _CrudWrapper2.default
  },
  ready: function ready() {
...
},{"./components/CrudWrapper.vue":78,"vue":76,"vue-resource":13,"vue-tables":14}]},{},[79]);
